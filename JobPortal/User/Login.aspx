                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <asp:DropDownList ID="ddlLoginType" runat="server" CssClass="form-contact w-100">
                                         ...
                                         <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="UserType is required" ForeColor="Red" Display="Dynamic" SetFocusOnError="true" Font-Size="Small" InitialValue="0"
